    ...
    SecurityFilterChain securityFilterChain(HttpSecurity httpSecurity) throws Exception {
        ...
        return httpSecurity
            ...
            .authorizeHttpRequests((authz) -> authz
                ...
                .requestMatchers(antMatcher(HttpMethod.GET,    "/workshops")).hasRole("ADMIN") 
                .requestMatchers(antMatcher(HttpMethod.POST,   "/injectors")).hasRole("USER")
                .requestMatchers(antMatcher(HttpMethod.POST,   "/vehicles")).hasRole("USER")
                .requestMatchers(antMatcher(HttpMethod.POST,   "/plans")).hasRole("USER")
                ...
                .requestMatchers(antMatcher(HttpMethod.POST,   "/workshops")).hasRole("ADMIN")
                .requestMatchers(antMatcher(HttpMethod.PUT,    "/injectors")).hasRole("USER")
                .requestMatchers(antMatcher(HttpMethod.PUT,    "/vehicles")).hasRole("USER")
                .requestMatchers(antMatcher(HttpMethod.PUT,    "/plans")).hasRole("USER")
                ...
                .requestMatchers(antMatcher(HttpMethod.PUT,    "/workshops")).hasRole("ADMIN")
                .requestMatchers(antMatcher(HttpMethod.DELETE, "/injectors")).hasRole("USER")
                .requestMatchers(antMatcher(HttpMethod.DELETE, "/vehicles")).hasRole("USER")
                .requestMatchers(antMatcher(HttpMethod.DELETE, "/plans")).hasRole("USER")
