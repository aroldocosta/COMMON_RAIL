    ...
    SecurityFilterChain securityFilterChain(HttpSecurity httpSecurity) throws Exception {
        ...
        return httpSecurity
            ...
            .authorizeHttpRequests((authz) -> authz
        		...
        		.requestMatchers(antMatcher(HttpMethod.POST, 	"/reports")).hasRole("USER")
        		...
        		.requestMatchers(antMatcher(HttpMethod.PUT, 	"/reports")).hasRole("USER")
        		...
        		.requestMatchers(antMatcher(HttpMethod.DELETE, 	"/reports")).hasRole("USER")
