...
public record TestDTO(String id, Integer injectorNumber, Long sequence, String comments, String date, Float resistance, Float inductance, Float isolation,
		Float halfLoad, Float fullLoad, Float idling, Float preInjection, Float halfLoadReturn, Float fullLoadReturn,
		Float idlingReturn, Float preInjectionReturn, String planId, String injectorId, String injectorModel,
		String vehicleId, String vehiclePlate, String imaCode, String serviceOrder

) {
	public TestDTO(Test t) {
		this(t.getId(), t.getInjectorNumber(), t.getSequence(), t.getComments(), t.getDate(), t.getResistance(), t.getInductance(), t.getIsolation(),
				...
				t.getInjector().getId(), t.getInjector().getModel(), t.getVehicle().getId(), t.getVehicle().getPlate(),
